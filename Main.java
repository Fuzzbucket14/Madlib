...
*/
    ...
    JOptionPane.showMessageDialog(null,"Title: The Silly School Day Today at " + School_Name +", it was "+Adjective+" day! Everyone was excited to wear their "+Color+" "+Clothing+" and bring their favorite "+Animal+" to class.  In the morning, the teacher, "+Teacher_Name+", announced a surprise field trip to the "+Adjective0+" "+Place+". Everyone had to pack a lunch with "+Number+" "+ FoodItems+" and a drink of "+Beverage+". On the bus, "+Friend_Name+" told a joke that made everyone "+Verb+". Even "+Teacher_Name+" couldn't stop "+Verbing+" with laughter! When they arrived at the "+Place+", "+Student_Name+" found a mysterious "+Object+" that granted the ability to "+Verb0+" "+Adverb+". It was so "+Adjective1+" that "+Student_Name+" started "+Verbing0+" all over the place. At the end of the day, everyone received a special "+Noun+" as a reward. It was a day filled with "+Adjective2+" memories.");
   }
}
